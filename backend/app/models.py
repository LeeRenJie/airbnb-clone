...
# This model is used to store different types of property types
class PropertyType(models.Model):
  name = models.CharField(max_length=100)

# This model is used to store different types of room types
class Room(models.Model):
  name = models.CharField(max_length=200)
  capacity = models.PositiveSmallIntegerField()

# This model is used to store different types of property
...
# This model is used to details of room bookings with a general booking
